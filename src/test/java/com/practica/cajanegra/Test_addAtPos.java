...
public class Test_addAtPos {
	...
	public void pruebaLista() throws EmptyCollectionException{
		...
		assertIterableEquals(obtenida1,esperada1);
		...
		assertIterableEquals(obtenida3,esperada3);
		...
		assertIterableEquals(obtenida4,esperada4);
		...
		assertIterableEquals(obtenida5,esperada5);
		...
		assertIterableEquals(obtenida6,esperada6);
	...
	public void pruebaVacia() {
		...
		assertIterableEquals(obtenida7,esperada7);
	...
	public void pruebaFueraDominio() {
		...
		assertIterableEquals(obtenida8,esperada8);
		...
		obtenida9.addAtPos('m',4);
	        assertIterableEquals(obtenida9,esperada9);	
		}
}
